    ...
    return(
        <>
            ...
            >
                ...
                <Button className='btn btn-dark category-btn' onClick={handleShow} style={{opacity:'0.8',paddingLeft:"25px"}}>LogOut <LogoutIcon style={{color:"yellow",paddingLeft:"5px"}}/></Button> 
                <Modal
                    show={show}
                    onHide={handleClose}
                    backdrop="static"
