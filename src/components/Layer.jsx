...
export default function Layer(){
    ...
    <Accordion>
      <Accordion.Item eventKey="0">
        <Accordion.Header><b>What is SPLASH ?</b></Accordion.Header>
        <Accordion.Body>
        If you're referring to your video-sharing platform, then Splash is a vibrant and exciting place for users to watch, upload, and share diverse video content. Think of it as YouTube with a fresh, community-focused twist, offering seamless streaming, advanced search, and features that encourage interaction and engagement.
        </Accordion.Body>
      </Accordion.Item>
      <Accordion.Item eventKey="1">
        <Accordion.Header><b> What makes Splash's streaming seamless?</b></Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion.Item eventKey="2">
        <Accordion.Header> <b> How does Splash keep me updated on new videos?</b></Accordion.Header>
        <Accordion.Body>
        <b>Personalized Recommendations:</b> Splash learns your preferences and suggests new videos you might enjoy, based on your watch history and likes. <br />
        <b>Channels and Subscriptions:</b> Follow your favorite creators and get notified when they upload new content. <br />
        <b>Trending Page:</b> Discover the hottest videos on Splash, across different categories and genres. <br />
        <b>Curated Playlists:</b> Explore thematic playlists created by Splash editors and fellow users.
        </Accordion.Body>
      </Accordion.Item>
      <Accordion.Item eventKey="3">
        <Accordion.Header> <b>How powerful is Splash's search engine?</b> </Accordion.Header>
        <Accordion.Body>
          ...
          <b>Auto-suggestions:</b> As you type, Splash suggests relevant searches and trending topics. <br />
          <b>Related videos:</b> Explore similar content after watching a video, for rabbit-hole adventures
        </Accordion.Body>
      </Accordion.Item>
      <Accordion.Item eventKey="4" >
        <Accordion.Header><b>How does Splash engage viewers beyond just watching videos?</b></Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion.Item eventKey="5">
        <Accordion.Header><b> How does Splash ensure high-quality videos and accessibility?</b></Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion.Item eventKey="6">
        <Accordion.Header> <b>What are your plans for the future of Splash?</b> </Accordion.Header>
        <Accordion.Body>
        We're constantly innovating to enhance the Splash experience. We plan to introduce new features like interactive video elements, advanced search and recommendation algorithms, and even original content programming. Stay tuned for exciting updates!
        </Accordion.Body>
      </Accordion.Item>
      <Accordion.Item eventKey="7">
        <Accordion.Header> <b>How does Splash compare to other video platforms?</b></Accordion.Header>
        <Accordion.Body>
        Splash aims to stand out with its user-friendly interface, diverse content library, strong focus on creator communities, and commitment to creating a safe and inclusive space for everyone. We encourage you to try us out and see the difference!
        </Accordion.Body>
      </Accordion.Item>
    </Accordion>
    ...
    <br />
    <div className="container">
    <h2 className="pb-2 border-bottom text-warning py-5">The Creators</h2>
    <hr />
     <br />
    <Slider /> 
    </div>
